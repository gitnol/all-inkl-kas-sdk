...
### `get_accountressources` *(deprecated: 2018-10-30: typo error, use get_accountresources())*
* **Req**: None
* **Opt**: None
* **Exc**: \array_return
...
### `update_account`
* **Req**: account_login, account_kas_password
...
### `update_chown`
* **Req**: chown_path, chown_user, recursive
* **Opt**: None
* **Exc**: \chownuser_syntax_incorrect, \directory_syntax_incorrect, \in_progress, \missing_parameter, \recursive_syntax_incorrect

## Package: cronjob

### `add_cronjob` *(deprecated: 2020-11-12: typo error mail_adress, use mail_address)*
* **Req**: protocol, http_url, cronjob_comment, minute, hour, day_of_month, month, day_of_week
* **Opt**: http_user, http_password, mail_address, mail_condition, mail_subject [Def: |comment (optional], is_active [Def: Y]
...
### `update_cronjob` *(deprecated: 2020-11-12: typo error mail_adress, use mail_address)*
* **Req**: cronjob_id
* **Opt**: protocol, http_url, cronjob_comment, minute, hour, day_of_month, month, day_of_week, http_user, http_password, mail_address, mail_condition, mail_subject [Def: |comment (optional], is_active
...
### `add_database`
* **Req**: database_password, database_comment
...
### `add_ddnsuser`
* **Req**: dyndns_comment, dyndns_password, dyndns_zone, dyndns_label, dyndns_target_ip
* **Opt**: None
...
* **Req**: directory_user, directory_path, directory_password, directory_authname
* **Opt**: None
...
* **Req**: directory_user, directory_path
* **Opt**: None
...
### `add_dkim`
* **Req**: host
* **Opt**: check_foreign_nameserver [Def: Y]
...
### `add_dns_settings` *(deprecated: 2016-01-14: Parameter nameserver wurde entfernt)*
* **Req**: zone_host, record_type, record_name, record_data, record_aux
* **Opt**: None
...
### `get_dns_settings` *(deprecated: 2016-01-14: Parameter nameserver wurde entfernt)*
* **Req**: zone_host
* **Opt**: record_id
* **Exc**: \array_return
...
### `move_domain`
* **Req**: domain_name, source_account, target_account
* **Opt**: None
...
### `add_mailaccount`
* **Req**: mail_password, local_part, domain_part
...
### `add_mailinglist`
* **Req**: mailinglist_name, mailinglist_domain, mailinglist_password
* **Opt**: None
...
### `add_sambauser`
* **Req**: samba_path, samba_new_password, samba_comment
* **Opt**: None
...
### `get_sambausers` *(deprecated: get_sambauser() ist deprecated)*
* **Req**: None
* **Opt**: samba_login
* **Exc**: \array_return
...
### `add_session`
* **Req**: session_lifetime, session_update_lifetime, session_2fa
* **Opt**: None
...
### `add_softwareinstall`
* **Req**: software_id, software_database, software_database_password, software_hostname, software_path, software_admin_mail, software_admin_user, software_admin_pass
...
### `update_ssl`
* **Req**: hostname, ssl_certificate_sni_key, ssl_certificate_sni_crt
...
### `get_traffic`
* **Req**: None
* **Opt**: year [Def: das aktuelle Jahr], month [Def: der aktuelle Monat]
* **Exc**: \array_return

## Package: subdomain

### `add_subdomain`
* **Req**: subdomain_name, domain_name
...
### `move_subdomain`
* **Req**: subdomain_name, source_account, target_account
* **Opt**: None
...
### `add_symlink`
* **Req**: symlink_target, symlink_name
* **Opt**: None
* **Exc**: \in_progress, \missing_parameter
